...
var last_lod_migration_count: int


func _init(active: int = 0, batches: int = 0, meshes: int = 0, hits: int = 0, misses: int = 0, immediate_commands: int = 0, immediate_batches: int = 0, lod_minimal: int = 0, lod_low: int = 0, lod_medium: int = 0, lod_high: int = 0, lod_extreme: int = 0, lod_transitions: int = 0, lod_migrations: int = 0) -> void:
	...
	last_lod_migration_count = lod_migrations
